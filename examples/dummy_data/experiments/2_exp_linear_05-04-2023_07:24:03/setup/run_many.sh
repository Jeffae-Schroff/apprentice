...
python3 ../../data_scripts/mc_envelope.py "${experiment_name}"
...
# it may be best to comment out everything after this line when running with new data, some ways of displaying data will break
# because they assumed two parameters, others (like contour) may take too much runtime.

pushd experiments/"${experiment_folder}"
python3 ../../data_scripts/save_setup.py ../../run_many.sh ../../data_scripts/"${experiment_name}".py
python3 ../../data_scripts/eigen_analysis.py "${experiment_name}" --use-wfile
...
pushd tunes/tune_0
python3 ../../../../data_scripts/graph_surrogates_and_target.py myweights.txt ../../data.json val_30.json err_20.json "${experiment_name}"
popd 
