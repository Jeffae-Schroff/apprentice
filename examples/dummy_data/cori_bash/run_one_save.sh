...
python3 data_scripts/gather_jobs_tune_data.py tune_no_errs $1 $2
python3 data_scripts/gather_jobs_tune_data.py tune_w_errs $1 $2
python3 data_scripts/gather_jobs_tune_data.py tune_w_cov $1 $2
